...
module.exports = function (grunt) {
    ...
    taskConfig.delta.coffeesrc.tasks = ['coffeelint:src', 'coffee:source', 'copy:build_appjs', indexTask];
    ...
    grunt.registerTask('watchmock', ['buildmock', 'express', 'delta']);
    ...
    grunt.registerTask('buildmock', [
        'clean:all', 'html2js', 'jshint', 'coffeelint', 'coffee', 'less:build',
        'concat:build_css', 'copy:build_app_assets', 'copy:build_vendor_assets',
        'copy:build_appjs', 'copy:buildmock_vendorjs', 'copy:build_vendorcss', 'ngAnnotate:build', 'index:mock'
